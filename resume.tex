...
\begin{document}
    \begin{spacing}{1}
        ...
        \splitbox{Skills:}{
            \textbf{Languages} C++, Python, JavaScript, HTML, CSS, SQL, Bash, LaTeX\\
            \textbf{Frameworks / Libraries:} React, Node.JS, Express, Flask, Pygame\\
            \textbf{Tools:} Git, VSCode, SQLite, MySQL}
        ...
        \project{ZoomZoomType}{January 2025 - May 2025}{\textbf{Github Link:} \url{https://github.com/SunCh1p/ZoomZoomType}}
        {
            \begin{itemize}
                ...
                \item Collaborated with a team of 4.
            \end{itemize}
            \par
        }
        \project{Visual Pathfinding}{January 2025 - May 2025}{\textbf{Github Link:} \url{https://github.com/SunCh1p/AIProject2025}}
        {
            \begin{itemize}
                \setlength\itemsep{0.01em}
        ...
        \project{Personal Website}{January 2025 - May 2025}{\textbf{Github Link:} \url{https://github.com/SunCh1p/PersonalWebsite}}
        {
            \begin{itemize}
                ...
                \item Implemented using React and Bootstrap\par
            \end{itemize}
            \par
        }
    \end{spacing}
