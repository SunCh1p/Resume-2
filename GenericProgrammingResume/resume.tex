...
\begin{document}
    \begin{spacing}{1}
        ...
        %Summary
        \splitbox{Objective:}{ Computer Science Graduate with skills in C++, python, javascript.}
        ...
        \normalsize
        \project{OpenGL Game}{August 2025 - December 2025}{\textbf{Github Link:} \url{https://github.com/SunCh1p/ComputerGraphicsClass}}
        {
            \begin{itemize}
                \setlength\itemsep{0.01em}
                \item 3D game built with C++ and FREEGLUT 
                \item Implemented an Entity Component System for most of game logic and rendering  \par
                \item Collision system, animations, projectile system, Model loading, Score System
            \end{itemize}
            \par
        }
        \project{Doc Reformed}{August 2025 - December 2025}{\textbf{Github Link:} \url{https://github.com/ch33s322/CS49999-Capstone}}
        {
            \begin{itemize}
                \setlength\itemsep{0.01em}
                \item Pdf splitting application developed with dotnet and wpf for capstone project
        ...
        \project{ItemQuest}{January 2025 - May 2025}{\textbf{Github Link:} \url{https://github.com/Item-Quest/TeamBravo}}
        {
            \begin{itemize}
                ...
                \item Collaborated with a team of 10 to design and build the project using an agile methodology called scrum and a kanban board on github
            \end{itemize}
            \par
        }
        \project{ZoomZoomType}{January 2025 - May 2025}{\textbf{Github Link:} \url{https://github.com/SunCh1p/ZoomZoomType}}
        {
            \begin{itemize}
                ...
                \item Typing game that works similar to type racer with several different game modes to choose from
            \end{itemize}
            \par
        }
    \end{spacing}
